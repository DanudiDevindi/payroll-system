...
public class LevelDTO {
    ...
    public LevelDTO(String leId, String lName, BigDecimal basicSalary, BigDecimal EPFAmount, String totalLeaves) {
        this.leId = leId;
        this.lName = lName;
    ...
    public String toString() {
        return "LevelDTO{" + "leId=" + leId + ", lName=" + lName + ", basicSalary=" + basicSalary + ", EPFAmount=" + EPFAmount + ", totalLeaves=" + totalLeaves + '}';
    }
