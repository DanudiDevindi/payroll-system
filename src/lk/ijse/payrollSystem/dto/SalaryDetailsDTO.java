...
public class SalaryDetailsDTO {
   private String sdId;
    ...
    public SalaryDetailsDTO(String sdId, String empId, String empname, String level, BigDecimal basicSalaryAmount, String salId, String date, BigDecimal noPay, BigDecimal loan, BigDecimal damages, BigDecimal epf, BigDecimal grossDeduction, BigDecimal netSalary) {
        this.sdId = sdId;
        this.empId = empId;
    ...
    public String toString() {
        return "SalaryDetailsDTO{" + "sdId=" + sdId + ", empId=" + empId + ", empname=" + empname + ", level=" + level + ", basicSalaryAmount=" + basicSalaryAmount + ", salId=" + salId + ", date=" + date + ", noPay=" + noPay + ", loan=" + loan + ", damages=" + damages + ", epf=" + epf + ", grossDeduction=" + grossDeduction + ", netSalary=" + netSalary + '}';
    }
