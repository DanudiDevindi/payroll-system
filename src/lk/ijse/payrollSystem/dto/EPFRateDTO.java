...
public class EPFRateDTO {
    ...
    public EPFRateDTO(String epfRId, BigDecimal amount, Double presentage) {
        this.epfRId = epfRId;
        this.amount = amount;
    ...
    public String toString() {
        return "EPFRateDTO{" + "epfRId=" + epfRId + ", amount=" + amount + ", presentage=" + presentage + '}';
    }
