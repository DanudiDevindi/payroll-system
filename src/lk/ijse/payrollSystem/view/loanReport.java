 ...
 * @author acer
 */
public class loanReport extends javax.swing.JFrame {
     private LoansController ctrl;

    /**
     * Creates new form loanReport
     */
    public loanReport() {
        ctrl=new LoansController();
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED, new java.awt.Color(0, 51, 51), new java.awt.Color(0, 51, 51), new java.awt.Color(0, 51, 51), new java.awt.Color(0, 51, 51)));
        ...
        EmployeeReporttbl.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "LoanId", "Emp Id", "Emp Name", "Level", "LoanAmount", "Date", "due", "month"
            }
        ));
        jScrollPane1.setViewportView(EmployeeReporttbl);

        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 160, 1060, 325));
        ...
        jPanel2.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(525, 552, -1, -1));

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(0, 102, 102));
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setText("Loans Report");
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(617, 31, 358, 53));
        ...
        jLabel3.setText("Loans Report");
        jLabel3.setOpaque(true);
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 542, 300, 50));
    ...
    private void PrintlblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PrintlblMouseClicked
          try {
            InputStream is = getClass().getResourceAsStream("/lk/ijse/payrollSystem/reports/Loans.jasper");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(loanReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new loanReport().setVisible(true);
            }
        });
    }
    ...
    private void getAllLoans() {
          try {
            ...
            ArrayList<LoansDTO> allLoans= ctrl.getAllLoans();
            
            DefaultTableModel dtm = (DefaultTableModel) EmployeeReporttbl.getModel();
            dtm.setRowCount(0);
            
            for (LoansDTO loans : allLoans) {
                Object[] rowData = {
            loans.getlId(),
                    loans.geteId(),
                    loans.geteName(),
      ...
      dtm.addRow(rowData);
            ...
            Logger.getLogger(loanReport.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
