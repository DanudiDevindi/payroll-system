...
public class ETFRateDTO {
    ...
    public ETFRateDTO(String etfId, BigDecimal amount, Double presentage) {
        this.etfId = etfId;
        this.amount = amount;
    ...
    public String toString() {
        return "ETFRateDTO{" + "etfId=" + etfId + ", amount=" + amount + ", presentage=" + presentage + '}';
    }
